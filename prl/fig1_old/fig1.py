...
# read active data
ac_path = 'data/ABPs'
ac_int_flag= 'Lx80_Ly50_v11_vcl2.5_vcr22.5_vr35_P1_N800_dt0.00025'    # interacting
ac_ni_flag = 'ni_Lx80_Ly50_v11_vcl2.5_vcr22.5_vr35_P1_N800_dt0.00025' # non-interacting

a_prof = np.genfromtxt(os.path.join(ac_path,'active-'+ac_int_flag+'-prof_avg'),delimiter='\t')
a_ni_prof = np.genfromtxt(os.path.join(ac_path,'active-'+ac_ni_flag+'-prof_avg'),delimiter='\t')
a_disp = np.genfromtxt(os.path.join(ac_path,'active-'+ac_int_flag+'-disp_one'),delimiter='\t')
a_ni_disp = np.genfromtxt(os.path.join(ac_path,'active-'+ac_ni_flag+'-disp_one'),delimiter='\t')
a_prof = a_prof[:,(0,2)]
a_ni_prof = a_ni_prof[:,(0,2)]

# read passive data
pa_path = 'data/PBPs'
pa_int_flag = 'Lx80_Ly50_T11_Tcl2.5_Tcr22.5_Tr35_P1_N800_dt0.00025'   # interacting
pa_ni_flag = 'ni_Lx80_Ly50_T11_Tcl2.5_Tcr22.5_Tr35_P1_N800_dt0.00025' # non-interacting

p_prof = np.genfromtxt(os.path.join(pa_path,'passive-'+pa_int_flag+'-prof_avg'),delimiter='\t')
p_ni_prof = np.genfromtxt(os.path.join(pa_path,'passive-'+pa_ni_flag+'-prof_avg'),delimiter='\t')
p_disp = np.genfromtxt(os.path.join(pa_path,'passive-'+pa_int_flag+'-disp_one'),delimiter='\t')
p_ni_disp = np.genfromtxt(os.path.join(pa_path,'passive-'+pa_ni_flag+'-disp_one'),delimiter='\t')
p_ni_prof = p_ni_prof[:,(0,2)]
p_prof = p_prof[:,(0,2)]


# import params (same for active and passive, except v <-> T)
p = get_params(os.path.join(ac_path,'active-param'))
...
# boundaries of nonzero v'(x) regions
